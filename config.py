...
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001875287218"))
AUTH_USERS = set(int(x) for x in os.environ.get("AUTH_USERS", "1916526576").split())
DB_URL = os.environ.get("DB_URL", "mongodb+srv://renamev3-1:renamev3-1@cluster0.hyv9toa.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DB_NAME", "indurlBroadcastBot")
